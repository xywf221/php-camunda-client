...
class GetTasksCountDto implements JsonSerializable, RequestPropertiesInterface
{
    ...
    /**
     * @var string|null Restrict to tasks with any of the given ids.
     */
    ...
    /**
     * @var string|null Restrict to tasks that belong to process instances with the given ids.
     */
    ...
    /**
     * @var string|null Restrict to tasks that belong to process instances with one of the give business keys.
    ...
    /**
     * @var string|null Restrict to tasks that belong to a process definition with one of the given keys. The
    ...
    /**
     * @var string|null Only include tasks which belong to one of the passed and comma-separated activity
     * instance ids.
     */
    public ?string $activityInstanceIdIn;

    /**
     * @var string|null Only include tasks which belong to one of the passed and comma-separated
     * tenant ids.
     */
    ...
    /**
     * @var string|null Restrict to tasks that the user described by the given expression is assigned to.
     * See the
     * [user guide](https://docs.camunda.org/manual/develop/user-guide/process-engine/expression-language/#internal-context-functions)
     * for more information on available functions.
     */
    ...
    /**
     * @var string|null Only include tasks which are assigned to one of the passed and
     * comma-separated user ids.
     */
    public ?string $assigneeIn;

    /**
     * @var string|null Only include tasks which are not assigned to one of the passed and
     * comma-separated user ids.
     */
    public ?string $assigneeNotIn;
    ...
    /**
     * @var string|null Restrict to tasks that have one of the given keys. The keys need to be in a
     ...
     * [default](https://docs.camunda.org/manual/develop/reference/rest/overview/date-format/), the date must have the
    ...
    /**
     * @var string|null Restrict to tasks that are due on the date described by the given expression.
     * @link https://docs.camunda.org/manual/develop/user-guide/process-engine/expression-language/#internal-context-functions for more information on available functions. The expression must evaluate to a
     ...
     * [default](https://docs.camunda.org/manual/develop/reference/rest/overview/date-format/), the
    ...
    /**
     * @var string|null Restrict to tasks that are offered to any of the given candidate groups. Takes a
    ...
    /**
     * @var string|null Only include tasks that have variables with certain values. Variable filtering
    ...
    /**
     * @var string|null Only include tasks that belong to case instances that have variables with certain
     * values. Variable filtering expressions are comma-separated and are structured as
     * follows:
     *
     * A valid parameter value has the form `key_operator_value`. `key` is the variable name,
     ...
     * `key` and `value` may not contain underscore or comma characters.
     */
    public ?string $caseInstanceVariables;
