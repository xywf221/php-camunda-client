...
class JobDefinitionQueryDto implements JsonSerializable, RequestPropertiesInterface
{
    ...
    /**
     * @var array<string>|null Only include job definitions which belong to one of the passed activity ids.
     */
    ...
    /**
     * @var array<string>|null Only include job definitions which belong to one of the passed tenant
     * ids.
     */
