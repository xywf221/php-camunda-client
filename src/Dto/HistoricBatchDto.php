...
class HistoricBatchDto implements JsonSerializable, RequestPropertiesInterface
{
    ...
    /**
     * @var string|null The batch creator's user id.
     */
    public ?string $createUserId;

    /**
     * @var string|null The time the batch was started. Default format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`.
     * For further information, please see the [documentation](https://docs.camunda.org/manual/develop/reference/rest/overview/date-format/)
     */
    public ?string $startTime;

    /**
     * @var string|null The time the batch execution was started, i.e., at least one batch job has been executed. Default format
    ...
    /**
     * @var string|null The time the batch ended. Default format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`.
     * For further information, please see the [documentation](https://docs.camunda.org/manual/develop/reference/rest/overview/date-format/)
     */
    public ?string $endTime;

    /**
     * @var string|null The time after which the historic batch should be removed by the History Cleanup
