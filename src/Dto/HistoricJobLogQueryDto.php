...
class HistoricJobLogQueryDto implements JsonSerializable, RequestPropertiesInterface
{
    ...
    /**
     * @var array<string>|null Only include historic job logs which belong to one of the passed activity ids.
     */
    public ?array $activityIdIn;

    /**
     * @var array<string>|null Only include historic job logs which belong to failures of one of the passed activity ids.
     */
    public ?array $failedActivityIdIn;

    /**
     * @var array<string>|null Only include historic job logs which belong to one of the passed execution ids.
     */
    ...
    /**
     * @var array<string>|null Only include historic job log entries which belong to one of the passed and comma-
