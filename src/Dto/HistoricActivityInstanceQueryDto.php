...
class HistoricActivityInstanceQueryDto implements JsonSerializable, RequestPropertiesInterface
{
    ...
    /**
     * @var array<string>|null Must be a JSON array of Strings. An activity instance must have one of the given tenant ids.
     */
