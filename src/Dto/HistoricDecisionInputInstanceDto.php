...
class HistoricDecisionInputInstanceDto implements JsonSerializable, RequestPropertiesInterface
{

    /**
     * @var string|null The id of the decision input value.
     */
    public ?string $id;

    /**
     * @var string|null The id of the decision instance the input value belongs to.
     */
    public ?string $decisionInstanceId;

    /**
     * @var string|null The id of the clause the input value belongs to.
     */
    public ?string $clauseId;

    /**
     * @var string|null The name of the clause the input value belongs to.
     */
