...
class HistoricDetailQueryDto implements JsonSerializable, RequestPropertiesInterface
{
    ...
    /**
     * @var array<string>|null Only include historic details which belong to one of the passed  process instance ids.
     */
    ...
    /**
     * @var array<string>|null Only include historic details where the variable updates belong to one of the passed
    ...
    /**
     * @var array<string>|null Filter by a  list of tenant ids.
     */
