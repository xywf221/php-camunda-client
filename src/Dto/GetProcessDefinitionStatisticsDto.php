...
class GetProcessDefinitionStatisticsDto implements JsonSerializable, RequestPropertiesInterface
{
    ...
    public function properties(): array
    {
        return [
            ...
            'rootIncidents' => $this->rootIncidents ?? null,
        ];
    }
