...
class ExternalTaskQueryDto implements JsonSerializable, RequestPropertiesInterface
{
    ...
    /**
     * @var array<string>|null Filter by the comma-separated list of external task ids.
     */
    public ?array $externalTaskIdIn;
    ...
    /**
     * @var array<string>|null Filter by the comma-separated list of ids of the activities that an external task is created for.
     */
    ...
    /**
     * @var array<string>|null Filter by a comma-separated list of process instance ids that an external task may belong to.
     */
    ...
    /**
     * @var array<object>|null A JSON array of criteria to sort the result by. Each element of the array is a JSON object that
