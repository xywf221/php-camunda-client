...
class GetProcessInstanceVariableDto implements JsonSerializable, RequestPropertiesInterface
{
    ...
    {
        return [
            'deserializeValue' => $this->deserializeValue ?? null,
        ];
    }
